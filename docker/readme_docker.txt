...
docker build -t attentionstimming -f docker/Dockerfile .

4. Once the image has finished building, launch a container in Docker desktop by clicking the play icon

5. Call the container something sensible (i.e. attentionstimming), set the host port to 8787, and add an Environment variable called PASSWORD with the value: pass
...
git clone https://github.com/bakerdh/attentionstimming.git
This will download the repository to a folder called attentionstimming
