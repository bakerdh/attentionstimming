...
Raw and processed data are available for both experiments at the project repository on the Open Science Framework website: http://doi.org/10.17605/OSF.IO/YUHZ4. Experiment code and analysis code are provided in the linked Github repository, which contains a fully computationally reproducible document written in Quarto, that generates this manuscript using the raw data. Neither experiment was preregistered.

# Acknowledgements

CS supported by a Bradshaw-Eagle Undergraduate Research Scholarship from the Applied Vision Association. DHB supported by BBSRC grant BB/V007580/1.
